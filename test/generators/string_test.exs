defmodule Generator.StringTest do
  ...
  describe "can_be_blank?" do
    test "will not yield a blank string" do
      strings = string(can_be_blank?: false) |> G.as_stream([]) |> Enum.take(100)
      refute Enum.any?(strings, &blank?/1)
    end
  end
